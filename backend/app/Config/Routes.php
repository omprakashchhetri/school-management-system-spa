...
$routes->group('post-login-employee', function ($routes) {
    ...
    $routes->group('fees', function ($routes) {
        ...
        $routes->post('fees-payments', 'Web\FeesModulePages\FeesModuleController::feesPaymentsList');
        ...
        Payment Page APIs
        -------------------------------- */
        $routes->post('get-sections-by-class', 'Web\FeesModulePages\FeesModuleController::getSectionsByClass');

        $routes->post('get-students-by-class-section', 'Web\FeesModulePages\FeesModuleController::getStudentsByClassSection');

        $routes->post('get-student-fees-ledger', 'Web\FeesModulePages\FeesModuleController::getStudentFeesLedger');

        $routes->post('record-payment', 'Web\FeesModulePages\FeesModuleController::recordPayment');
        $routes->post('generate-fees', 'Web\FeesModulePages\FeesModuleController::generateFees');
