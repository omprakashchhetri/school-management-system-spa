                     ...
                     <ul class="nav common-tab style-two nav-pills mb-0" id="pills-tab" role="tablist">
                         ...
                         <li class="nav-item" role="presentation">
                             <button class="nav-link" id="pills-plan-tab" data-bs-toggle="pill"
                                 data-bs-target="#pills-plan" type="button" role="tab" aria-controls="pills-plan"
                                 aria-selected="false">
                                 Plan
                             </button>
                         </li>
                     ...
                     <div class="card-body">
                         <form action="setting.html#">
                             <div class="row gy-4">
                                ...
                                background-image: url('<?=base_url()?>assets/images/thumbs/setting-profile-img.jpg');
                              "></div>
                                             </div>
                                         </div>
                                         <div
                     ...
                     <div class="col-lg-6">
                         <div class="card mt-24">
                             <div class="card-body">
                                 ...
                                 <p class="text-gray-600 text-15 rounded-8 border border-gray-100 p-16">
                                     Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                     Commodo pellentesque massa tellus ac augue. Lectus arcu at
                                     in in rhoncus malesuada ipsum turpis.
                                 </p>
                             </div>
                         </div>
                         <div class="card mt-24">
                                         ...
                                         <div class="flex-align align-items-start gap-12">
                                             ...
                                             <div>
                                                 ...
                                                 <p class="text-gray-600 text-15">
                                                     ...
                                                     elit. Commodo pellentesque massa
                                                 </p>
                                             </div>
                                         </div>
                                         <button type="button"
                                             class="flex-shrink-0 fw-bold text-13 text-main-600 flex-align gap-8 hover-text-main-800">
                                             Reply
                                             <i class="ph ph-arrow-bend-up-left d-flex text-lg"></i>
                                         </button>
                                     </div>
                                 </div>
                             ...
                             <div class="card-body">
                                 <div class="row gy-4">
                                     <div class="col-xxl-4 col-xl-6 col-md-4 col-sm-6">
                                         <div
                                             class="statistics-card p-xl-4 p-16 flex-align gap-10 rounded-8 bg-main-50">
                                             <span
                                     ...
                                     <div class="col-xxl-4 col-xl-6 col-md-4 col-sm-6">
                                         <div
                                             class="statistics-card p-xl-4 p-16 flex-align gap-10 rounded-8 bg-info-50">
                                             <span
                                     ...
                                     <div class="col-xxl-4 col-xl-6 col-md-4 col-sm-6">
                                         <div
                                             class="statistics-card p-xl-4 p-16 flex-align gap-10 rounded-8 bg-purple-50">
                                             <span
                             ...
                             <div class="card-body">
                                 ...
                                 <div class="recent-post rounded-8 border border-gray-100 p-16 d-flex gap-12 mb-16">
                                     <div class="d-inline-flex w-100 max-w-130 flex-shrink-0">
                                         <img src="<?=base_url()?>assets/images/thumbs/recent-post-img1.png" alt=""
                                             class="rounded-6 cover-img max-w-130" />
                                     </div>
                                     <div>
                                         <p class="text-gray-600 text-line-3">
                                             Lorem ipsum dolor sit amet, consectetur adipiscing
                                         ...
                                         <div class="flex-align gap-8 mt-24">
                                             <img src="<?=base_url()?>assets/images/thumbs/user-img1.png" alt=""
                                 ...
                                 <div class="recent-post rounded-8 border border-gray-100 p-16 d-flex gap-12 mb-16">
                                     <div class="d-inline-flex w-100 max-w-130 flex-shrink-0">
                                         <img src="<?=base_url()?>assets/images/thumbs/recent-post-img2.png" alt=""
                                             class="rounded-6 cover-img max-w-130" />
                                     </div>
                                     <div>
                                         <p class="text-gray-600 text-line-3">
                                         ...
                                         <div class="flex-align gap-8 mt-24">
                                             <img src="<?=base_url()?>assets/images/thumbs/user-img2.png" alt=""
                                                 class="w-32 h-32 rounded-circle cover-img" />
                     ...
                     <div class="card-body">
                         <div class="row gy-4">
                             <div class="col-md-4 col-sm-6">
                                 <div
                                     class="plan-item rounded-16 border border-gray-100 transition-2 position-relative">
                                     <span class="text-2xl d-flex mb-16 text-main-600"><i
                                             class="ph ph-package"></i></span>
             ...
             <div class="tab-pane fade" id="pills-billing" role="tabpanel" aria-labelledby="pills-billing-tab"
                             ...
                             <div class="col-lg-7">
                                 <div class="card border border-gray-100">
                                     <div class="card-header border-bottom border-gray-100 flex-between gap-8">
                                         ...
                                         <a href="setting.html#" class="btn btn-outline-main rounded-pill py-6">Add New
                                             Card</a>
                                     </div>
                                     <div class="card-body">
                                         <div
                                             ...
                                             <div class="flex-align align-items-start gap-16">
                                                 <div>
                                                     <img src="<?=base_url()?>assets/images/thumbs/payment-method1.png"
                                                         alt="" class="w-54 h-40 rounded-8" />
                                                 </div>
                                                 <div>
                                                     ...
                                                     <div
                                                         ...
                                                         <a href="setting.html#" class="fw-bold">Edit</a>
                                                     </div>
                                                 </div>
                                             </div>
                                             <label
                                         ...
                                         <div
                                             ...
                                             <div class="flex-align align-items-start gap-16">
                                                 <div>
                                                     <img src="<?=base_url()?>assets/images/thumbs/payment-method2.png"
                                                         alt="" class="w-54 h-40 rounded-8" />
                                                 </div>
                                                 <div>
                                                     <h6 class="title mb-0">
                 ...
                 <div class="card mt-24">
                     <div class="card-header border-bottom">
                         <div class="flex-between flex-wrap gap-16">
                             ...
                             <div class="flex-align flex-wrap justify-content-end gap-8">
                                 <button type="button"
                                     class="toggle-search-btn btn btn-outline-main bg-main-100 border-main-100 text-main-600 rounded-pill py-9">
                                     Add Filter
                                 </button>
                     ...
                     <div class="card toggle-search-box border-bottom border-gray-100 rounded-0">
                         <div class="card-body">
                             <form action="setting.html#" class="search-input-form">
                         ...
                         <table id="studentTable" class="table table-lg table-striped w-100">
                             <thead>
                                 <tr>
                                     ...
                                     <th class="h6 text-gray-600">
                                         <span class="position-relative"> Invoices </span>
                                     </th>
                             ...
                             <tbody>
                                 <tr>
                                     ...
                                     <td>
                                         <div class="flex-align gap-10">
                                             <div class="w-32 h-32 bg-gray-50 flex-center rounded-circle p-2">
                                                 <img src="<?=base_url()?>assets/images/thumbs/invoice-logo1.png" alt=""
                                                     class="" />
                                             </div>
                                             <div class="">
                                     ...
                                     <td class="text-center">
                                         <span
                                             class="text-success-600 bg-success-100 py-2 px-10 rounded-pill">Paid</span>
                                     </td>
                                     <td class="text-center">
                                     ...
                                     <td class="text-center">
                                         <button type="button"
                                             class="btn btn-outline-main bg-main-100 border-main-100 text-main-600 rounded-pill py-12">
                                             Download
                                         </button>
                                     </td>
                                 </tr>
                                 <tr>
                                     ...
                                     <td>
                                         <div class="flex-align gap-10">
                                             <div class="w-32 h-32 bg-gray-50 flex-center rounded-circle p-2">
                                                 <img src="<?=base_url()?>assets/images/thumbs/invoice-logo2.png" alt=""
                                                     class="" />
                                             </div>
                                             <div class="">
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         <div class="flex-align gap-10">
                                             <div class="w-32 h-32 bg-gray-50 flex-center rounded-circle p-2">
                                                 <img src="<?=base_url()?>assets/images/thumbs/invoice-logo4.png" alt=""
                                                     class="" />
                                             </div>
                                             <div class="">
                         ...
                         <div class="pt-24 pb-24 border-bottom border-gray-100">
                             <div class="row gy-4">
                                 <div class="col-sm-6 col-xs-6">
                                     ...
                                     <p class="max-w-280 text-gray-600 text-13">
                         ...
                         <div class="pt-24 border-bottom border-gray-100">
                             <div class="row gy-4">
                                 <div class="col-sm-6 col-xs-6">
                                     ...
                                     <p class="max-w-280 text-gray-600 text-13">
                                         These are notification for posts on your profile, likes
