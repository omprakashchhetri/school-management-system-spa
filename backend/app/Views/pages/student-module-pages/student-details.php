<div class="dashboard-body">
    ...
    <div class="breadcrumb mb-24">
        <ul class="flex-align gap-4">
            <li>
                <a href="dashboard" class="text-gray-200 fw-normal text-15 hover-text-main-600">Home</a>
            </li>
            <li>
                <span class="text-gray-500 fw-normal d-flex"><i class="ph ph-caret-right"></i></span>
            </li>
            <li>
                <a href="profile" class="text-gray-200 fw-normal text-15 hover-text-main-600">Students</a>
            </li>
            <li>
                <span class="text-gray-500 fw-normal d-flex"><i class="ph ph-caret-right"></i></span>
            </li>
            ...
            <div class="setting-profile px-24" style="margin-top: -50px;">
                <div class="flex-between flex-wrap">
                    <div class="d-flex align-items-end flex-wrap mb-20 gap-24">
                        ...
                        <div>
                            <h4 class="mb-8"><?=$studentData['firstname']?> <?=$studentData['middlename']?>
                                <?=$studentData['lastname']?></h4>
                            <div class="setting-profile__infos flex-align flex-wrap gap-16">
                                <div class="flex-align gap-6">
                                    ...
                                    <span class="text-gray-600 d-flex text-15">Grade
                                        <?=$studentData['class_name']?><?=$studentData['section_name']?></span>
                                </div>
                                <div class="flex-align gap-6">
