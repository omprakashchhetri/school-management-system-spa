                                ...
                                <td>
                                    <div class="flex-align gap-8">
                                        <div class="w-40 h-40 rounded-circle bg-main-600 flex-center flex-shrink-0">
                                            <img src="<?=base_url()?>assets/images/icons/course-name-icon1.png"
                                                alt="" />
                                        </div>
                                        <div class="">
                                ...
                                <td>
                                    <div class="flex-align gap-8">
                                        <div class="w-40 h-40 rounded-circle bg-purple-600 flex-center">
                                            <img src="<?=base_url()?>assets/images/icons/course-name-icon2.png"
                                                alt="" />
                                        </div>
                                        <div class="">
                                ...
                                <td>
                                    <div class="flex-align gap-8">
                                        <div class="w-40 h-40 rounded-circle bg-warning-600 flex-center">
                                            <img src="<?=base_url()?>assets/images/icons/course-name-icon3.png"
                                                alt="" />
                                        </div>
                                        <div class="">
                                ...
                                <td>
                                    <div class="flex-align gap-8">
                                        <div class="w-40 h-40 rounded-circle bg-main-two-600 flex-center">
                                            <img src="<?=base_url()?>assets/images/icons/course-name-icon4.png"
                                                alt="" />
                                        </div>
                                        <div class="">
                                                            ...
                                                            <li class="mb-0">
                                                                <button type="button"
                                                                    ...
                                                                    <span class="text d-flex align-items-center gap-8">
                                                                        <i class="ph ph-trash"></i> Remove</span>
                                                                </button>
                                                            </li>
                                                        </ul>
                                                    </div>
                                        ...
                                        <ul>
                                            <li class="mb-0">
                                                <a href="students.html"
                                                    ...
                                                    <span class="text">
                                                        <i class="ph ph-user me-4"></i> View</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
